...
OUTPUT_DIRS = {
    'mean': './output_images_grayscale_mean/',
    'sd': './output_images_grayscale_sd/',
    'variance': './output_images_grayscale_variance/',
    'kurtosis': './output_images_grayscale_kurtosis/',
    'skewness': './output_images_grayscale_skewness/',
    'boxplot': './output_images_grayscale_boxplot/'  # Added box plot directory
}
...
def process_layer(layer_id, game_states, activation_data):
    ...
    color_map = {}
    for i in blue_idxs:  color_map[i] = '#888888' #'#1F77B4'
    for i in green_idxs: color_map[i] = '#EEEEEE' #'#28CD1E'
    for i in red_idxs:   color_map[i] = '#333333' #'#D14D50'
